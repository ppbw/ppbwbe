<header> <!-- Defining the header section of the page with the appropriate tag -->	
	...
	<div id="news">Rencontre des pirates ce <b>vendredi 21 septembre à 19h30</b> sur la place des Doyens à Louvain-La-Neuve.  <b>Feel welcome!</b></div>
	...
	<a href="/"><img src="img/Logo-bw.png" alt="logo du ppbw"/></a>
		...
		<div class="social">
			...
			<a href="http://www.facebook.com/pages/Parti-Pirate-Brabant-wallon/132640623428484" class="external text facebook-link" rel="nofollow"></a>	
		</div>		
	...
	<nav class="clear"> <!-- The nav link semantically marks your main site navigation -->
		<ul>
			<li><a <?php nav_current("index"); ?> href="/">Accueil</a></li>
